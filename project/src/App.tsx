...
import { DownloadPromoField } from './pages/DownloadPromoField';
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <ul className="space-y-2 text-sm text-gray-700 font-mono">
              <li className="flex items-center">
                <span className={`mr-2 ${import.meta.env.VITE_SUPABASE_URL ? 'text-green-600' : 'text-red-600'}`}>
                  {import.meta.env.VITE_SUPABASE_URL ? '✓' : '✗'}
                </span>
                VITE_SUPABASE_URL
              </li>
              <li className="flex items-center">
                <span className={`mr-2 ${import.meta.env.VITE_SUPABASE_ANON_KEY ? 'text-green-600' : 'text-red-600'}`}>
                  {import.meta.env.VITE_SUPABASE_ANON_KEY ? '✓' : '✗'}
                </span>
                VITE_SUPABASE_ANON_KEY
              </li>
              <li className="flex items-center">
                <span className={`mr-2 ${import.meta.env.VITE_STRIPE_PUBLISHABLE_KEY ? 'text-green-600' : 'text-gray-400'}`}>
...
function AppContent() {
  ...
  const showNavigation = location !== '/login' && location !== '/download-promo-field';
  const [isCartModalOpen, setIsCartModalOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Routes>
        ...
        <Route path="/download-promo-field" element={<DownloadPromoField />} />
        <Route path="/DEPLOY-THIS-NOW.html" element={<DownloadPromoField />} />
