...
Deno.serve(async (req: Request) => {
  try {
    ...
    const { bookingId, paymentIntentId, amountToCapture, reason } = await req.json();
    ...
    await supabase
      ...
      .update({
        ...
        deposit_captured_amount: amountToCapture || 500,
        deposit_capture_reason: reason || 'Damages or violations',
      })
      .eq('id', bookingId);
