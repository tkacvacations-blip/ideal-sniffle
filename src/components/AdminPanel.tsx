...
import { Calendar, CheckCircle, Clock, Download, Link as LinkIcon, RefreshCw, List, CalendarDays, Home, Mail, Image, Receipt, Settings } from 'lucide-react';
...
export function AdminPanel() {
  ...
  const [activeTab, setActiveTab] = useState<'list' | 'calendar' | 'properties' | 'rentals' | 'taxes' | 'settings'>('settings');
